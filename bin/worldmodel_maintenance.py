...
from worldmodel_common import DAILY_RUNS_HEADER, DOCS_DIR, ENTITIES_DIR, ENTITIES_HEADER, ESTIMATES_HEADER, RELATIONSHIPS_HEADER, ROOT, SOURCE_LOG_HEADER, WIKI_PAGES, markdown_links, parse_index_entities, read_csv, validate_header
...
def main() -> int:
    ...
    if not DOCS_DIR.exists():
        findings.append('docs/ missing; run render script')
