...
Render Markdown to static HTML in `docs/`.

Rules:

- preserve Markdown source links;
- generate index pages for entities, reports, relationships, and estimates;
...
- GitHub Pages output was rendered;
