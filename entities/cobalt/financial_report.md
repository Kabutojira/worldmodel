# Cobalt Financial Report

## Entity summary

Cobalt is tracked as a key input and pricing signal because Battery commodity with ethical/supply risk. The bootstrap emphasizes supply-demand, price transmission, and downstream exposure.

## Business lines

- Pricing is driven by battery cathode demand, DRC supply risk, and chemistry shifts away from cobalt intensity.
...
- Priority KPIs: cobalt, DRC cobalt, battery cathode, NMC, Cobalt.
...
- <a href="https://www.iea.org/reports/global-critical-minerals-outlook-2025">Cobalt official page</a> (official site)
